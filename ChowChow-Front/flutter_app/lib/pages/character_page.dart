...
class _CharacterPageState extends State<CharacterPage>
  ...
  String _getGifPath() {
    ...
    if (_petType == 'CAT') {
      ...
      path = 'assets/gifs/${catGroup}_$anim.gif';
      debugPrint('🎯 [CharacterPage] CAT - group=$_groupName, catGroup=$catGroup, anim=$anim, path=$path');
    } else {
      final group = _getGroupNumber();
      path = 'assets/gifs/group${group}_$anim.gif';
      debugPrint('🎯 [CharacterPage] DOG - groupName=$_groupName, group=$group, anim=$anim, path=$path');
    }
      ...
      if (widget.characterId != null) {
        ...
        if (groupName == null && c['petId'] != null) {
          try {
            ...
            groupName = pet['group_name'] as String? ?? pet['groupName'] as String?;
          } catch (e) {
