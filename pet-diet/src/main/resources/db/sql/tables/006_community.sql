...
CREATE TABLE "CommunityPosts" (
    ...
    "petId"        INTEGER      NULL REFERENCES "UserPets"("petId")     ON DELETE SET NULL,
    "recipeId"     INTEGER      NULL REFERENCES "Recipes"("recipeId")   ON DELETE SET NULL,
    "petType"      VARCHAR(3)   NULL CHECK ("petType" IN ('DOG', 'CAT')),
    "postTitle"    VARCHAR(300) NOT NULL,
    "postContent"  TEXT         NOT NULL,
    "postCategory" VARCHAR(30)  NULL CHECK ("postCategory" IN ('자유', '후기', '질문', '레시피')),
