...
public class CharacterService {
    ...
    public CharacterResponse createCharacter(UUID authUuid, CharacterRequest req) {
        ...
        if (req.getPetId() != null) {
            ...
            if (req.getCharacterName() != null) pet.update(req.getCharacterName(), null, null, null, null, null, null, req.getBreedId(), null, null, null);
            if (req.getCharacterImageUrl() != null) {
                pet.update(null, null, null, null, null, null, req.getCharacterImageUrl(), null, null, null, null);
            }
    ...
    public CharacterResponse updateCharacterName(UUID authUuid, Integer petId, String characterName) {
        ...
        pet.update(characterName, null, null, null, null, null, null, null, null, null, null);
        userPetRepository.save(pet);
